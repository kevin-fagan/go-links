...
// AuditTable retrieves paginated audit records from the repository
// and renders them into the "table-audit.html" template.
func (cs *ComponentService) AuditTable(g *gin.Context) {
	renderTable(g, cs.linkRepository.GetAudit, "table-audit.html", "Audit")
}
...
func (cs *ComponentService) LinkTable(g *gin.Context) {
	renderTable(g, cs.linkRepository.GetLinks, "table-links.html", "Links")
}
